    ...
    )
{
    ...
    _configuration = configuration;
        ...
        public async Task<IActionResult> WebFactorUpdateRow([FromBody] FactorRow factorRow)
        {
            ...
            string UserId = WebUtility.UrlDecode(HttpContext.Request.Headers["UN"].FirstOrDefault()) ?? string.Empty;
            ...
            {
                _logger.LogError(ex, "Error occurred in {Function}", nameof(WebFactorUpdateRow));
                return StatusCode(500, "Internal server error.");
            }
        }
