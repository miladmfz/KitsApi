...
namespace webapikits.Controllers.MobileWebApi
{
    ...
    public class KowsarController : ControllerBase
    {
        ...
        private readonly ILogger<KowsarController> _logger;
        ...
        public KowsarController(
            ...
            ILogger<KowsarController> logger,
            ...
            */
            ...
            foreach (Printer printer in Printers)
            {
                ...
                if (report.Prepare())
                {
                    ...
                    fileManager.SavePdfToStorage(ms, _configuration.GetValue<string>("AppSettings:Pdf_SaveStorage"));
                    pdfPrinter.PrintPdf(_configuration.GetValue<string>("AppSettings:Pdf_SaveStorage"), printer.PrinterName);
