...
using webapikits.Model;using Newtonsoft.Json;
...
namespace webapikits.Controllers.MobileWebApi
{
...
public class OcrController : ControllerBase
    ...
    string Shortage
        ...
        public async Task<IActionResult> SaveOcrImage([FromBody] OcrModel ocrModel)
        {
            ...
            string imagePath = _configuration.GetValue<string>("AppSettings:Ocr_imagePath") + $"{imageName}"; // Provide the path where you want to save the image
            string image_zipPath = _configuration.GetValue<string>("AppSettings:Ocr_imagePath") + $"{imageName_zip}"; // Provide the path where you want to save the zip file
