...
namespace webapikits.Controllers.GozareshatWebApi
{
...
public class ReportWebController : ControllerBase
    {
        ...
        private readonly ILogger<ReportWebController> _logger;
        ...
        public ReportWebController(
            ...
            ILogger<ReportWebController> logger,
        ...
        public async Task<IActionResult> GetReports([FromBody] SearchTargetDto searchTargetDto)
        {
            ...
            var UserName = WebUtility.UrlDecode(HttpContext.Request.Headers["UN"].FirstOrDefault()) ?? string.Empty;
        ...
        [HttpGet]
        [Route("GetAllGridSchemaReport")]
        public async Task<IActionResult> GetAllGridSchemaReport(string ClassName)
        {
            ...
            {
                _logger.LogError(ex, "Error occurred in {Function}", nameof(GetAllGridSchemaReport));
                return StatusCode(500, "Internal server error.");
            }
        ...
        public async Task<IActionResult> CashReceiveCheckRpt([FromBody] SearchTargetReportDto searchTargetReportDto)
        {
            ...
            var UserName = WebUtility.UrlDecode(                HttpContext.Request.Headers["UI"].FirstOrDefault()) ?? string.Empty;
