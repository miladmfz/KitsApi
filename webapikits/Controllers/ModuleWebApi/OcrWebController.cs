...
namespace webapikits.Controllers.ModuleWebApi
{
    ...
    public class OcrWebController : ControllerBase
    {
        ...
        private readonly ILogger<OcrWebController> _logger;
        ...
        public OcrWebController(
            ...
            ILogger<OcrWebController> logger,
        ...
        public async Task<IActionResult> GetAttachFileAsync(string AttachedFileCode, string ClassName, string ObjectRef)
        {
            ...
            string data_zipPath = _configuration.GetValue<string>("AppSettings:Ocr_imagePath") + $"{dataName_zip}";
