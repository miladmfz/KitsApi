...
namespace webapikits.Controllers.ModuleWebApi
{
...
public class BrokerWebController : ControllerBase
    {
        ...
        private readonly ILogger<BrokerWebController> _logger;
        ...
        public BrokerWebController(
            ...
            ILogger<BrokerWebController> logger,
        ...
        public async Task<IActionResult> UploadImage([FromBody] ksrImageModeldto data)
        {
                ...
                string filePath = _configuration.GetValue<string>("AppSettings:web_imagePath") + $"{data.ObjectCode}.jpg"; // Provide the path where you want to save the image
